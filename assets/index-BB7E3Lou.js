...
`)}get variablesInfo(){if(this.uniforms.length===0)return;let e=t=>[12,10,1,6][["u32","f16","f32","i32"].indexOf(t)];return this.uniforms.map(t=>[e(t.type),t.length??1])}},Gp=(e,t)=>new Zo(e,t)}),Yo,ra,Xo,Qo,Jo,eu,Ze,Fp,Hp,Ot=W(()=>{"use strict";ne(),le(),Be(),de(),Yo=(e,t)=>{if(!e||e.length!==1)throw new Error("Transpose requires 1 input.");if(t.length!==0&&t.length!==e[0].dims.length)throw new Error(`perm size ${t.length} does not match input rank ${e[0].dims.length}`)},ra=(e,t)=>t.length!==0?t:[...new Array(e).keys()].reverse(),Xo=(e,t)=>M.sortBasedOnPerm(e,ra(e.length,t)),Qo=(e,t,r,i)=>{let a=`fn perm(i: ${i.type.indices}) -> ${r.type.indices} {
...
}`,Oc=e=>{let t=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Erf",r=>`erf_vf32(${r})`,ii(t)))},Bc=e=>{e.compute($e(e.inputs[0],"Exp","exp"))},Mc=e=>{e.compute($e(e.inputs[0],"Floor","floor"))},Rc=e=>{let t=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Gelu",r=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`,ii(t)))},Nc=(e,t)=>{let r=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"LeakyRelu",i=>`select(leaky_relu_alpha_ * ${i}, ${i}, ${i} >= vec4<${r}>(0.0))`,`const leaky_relu_alpha_ = ${r}(${t.alpha});`,t.cacheKey))},Dc=e=>{e.compute($e(e.inputs[0],"Not",t=>`!${t}`))},Pc=e=>{e.compute($e(e.inputs[0],"Neg",t=>`-${t}`))},Uc=e=>{e.compute($e(e.inputs[0],"Reciprocal",t=>`1.0/${t}`))},Lc=e=>{let t=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"Relu",r=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`))},qc=e=>{e.compute($e(e.inputs[0],"Sigmoid",t=>`(1.0 / (1.0 + exp(-${t})))`))},Vc=e=>xe(e),Wc=(e,t)=>{let r=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"HardSigmoid",i=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${i} + vec4<${r}>(${t.beta})))`,void 0,t.cacheKey))},Gc=e=>{let t=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"HardSwish",r=>`${r} * max(vec4<${t}>(0.0), min(vec4<${t}>(1.0), vec4<${t}>(${t}(1.0 / 6.0)) * ${r} + vec4<${t}>(0.5)))`))},Fc=e=>{e.compute($e(e.inputs[0],"Sin","sin"))},Hc=e=>{e.compute($e(e.inputs[0],"Sinh","sinh"))},jc=e=>{e.compute($e(e.inputs[0],"Sqrt","sqrt"))},Kc=e=>{e.compute($e(e.inputs[0],"Tan","tan"))},aa=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,Zc=e=>{e.compute($e(e.inputs[0],"Tanh",aa))},Fa=(e="f32")=>`
...
`,Ha=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,Yc=e=>{let t=Re(e.inputs[0].dataType);e.compute($e(e.inputs[0],"FastGelu",Ha,Fa(t),void 0,e.inputs[0].dataType))},Xc=(e,t)=>{let r=Re(e.inputs[0].dataType);return e.compute($e(e.inputs[0],"ThresholdedRelu",i=>`select(vec4<${r}>(0.0), ${i}, ${i} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`,t.cacheKey)),0},Qc=e=>{e.compute($e(e.inputs[0],"Log","log"))},Mu=(e,t)=>`
...
`)},Wu=(e,t,r,i)=>{let a=M.size(r),n=new Array(e.length),s=new Array(e.length),u=0,l=[],d=[],c=[{type:12,data:a}];for(let _=0;_<e.length;++_)u+=e[_].dims[t],n[_]=u,d.push(e[_].dims.length),s[_]=U(`input${_}`,i,d[_]),l.push("rank"),c.push({type:12,data:n[_]});for(let _=0;_<e.length;++_)c.push(...ae(e[_].dims));c.push(...ae(r));let h=te("output",i,r.length),g=h.indicesGet("indices",t),b=Array.from(Array(n.length).keys()).map(_=>`uniforms.sizeInConcatAxis${_}`).join(","),y=_=>`
  ...
  ${_.mainStart()}
    ...
    ${Vu(s,h)}
  }`;return{name:"Concat",shaderCache:{hint:`${t}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:r,dataType:i}],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:c}),getShaderSource:y}},ph=(e,t)=>{let r=e.inputs,i=r[0].dims,a=M.normalizeAxis(t.axis,i.length);Lu(r,a);let n=i.slice();n[a]=r.reduce((u,l)=>u+(l.dims.length>a?l.dims[a]:0),0);let s=r.filter(u=>M.size(u.dims)>0);e.compute(Wu(s,a,n,r[0].dataType),{inputs:s})},ch=e=>xe({axis:e.axis})}),Ft,Ht,jt,wn,Zt=W(()=>{"use strict";ne(),le(),Ft=(e,t,r="f32")=>{switch(e.activation){case"Relu":return`value = max(value, ${t}(0.0));`;case"Sigmoid":return`value = (${t}(1.0) / (${t}(1.0) + exp(-value)));`;case"Clip":return`value = clamp(value, ${t}(${r}(uniforms.clip_min)), ${t}(${r}(uniforms.clip_max)));`;case"HardSigmoid":return`value = max(${t}(0.0), min(${t}(1.0), ${r}(uniforms.alpha) * value + ${r}(uniforms.beta)));`;case"LeakyRelu":return`value = select(${r}(uniforms.alpha) * value, value, value >= ${t}(0.0));`;case"Tanh":return`let e2x = exp(-2.0 * abs(value));
...
`}return X};return`
  ${k.registerUniforms(Y).registerInternalVariables(C).declareVariables(...K,$)}
  ${k.mainStart()}
  ...
  `};return{name:"MatMulNaive",shaderCache:{hint:`${t.activation};${h};${g};${b};${a}`,inputDependencies:_?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:n?n(r):r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:w}),getShaderSource:I}}}),Gu,Fu,ja,na,Hu,Ka,ju,ui,xn=W(()=>{"use strict";ne(),le(),de(),Zt(),$n(),_n(),Gu=(e,t)=>e?`
    ...
    for (var i = 0u; i < ${s}u; i++) {
      ...
      ${_.set("batch","row","col + i","output_channel","value")};
        ...
        `,c===1)q+=`
          ...
          `;return`
    ${V.registerUniforms(K).declareVariables(..._e,G)}
      ${V.mainStart()}
...
`)};
  ...
  ${g.mainStart()}
    ...
    }`};return{name:"GatherBlockQuantized",shaderCache:{hint:`${t.cacheKey};${e.filter((b,y)=>y!==1).map(b=>b.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(b,y)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:h}),getShaderSource:g}},Dh=(e,t)=>{let r=e.inputs;Cl(r,t),e.compute(zl(e.inputs,t))},Ph=e=>xe({blockSize:e.blockSize,gatherAxis:e.gatherAxis,quantizeAxis:e.quantizeAxis})}),Al,Ol,Uh,Lh,J0=W(()=>{"use strict";ne(),le(),Be(),de(),Al=e=>{if(!e||e.length!==2)throw new Error("GatherElements requires 2 inputs.");if(e[0].dims.length<1)throw new Error("GatherElements requires that the data input be rank >= 1.");if(e[0].dims.length!==e[1].dims.length)throw new Error(`GatherElements requires that the data input and
...
`,ql=(e,t,r)=>(()=>{switch(r.mode){case"nearest":return`
  ...
  }`};return e.compute({name:"MultiHeadAttentionAddBias",shaderCache:{inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:u,dataType:t.dataType,gpuDataType:0}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:c},{inputs:[t,r],outputs:[-1]})[0]},vr=(e,t,r,i,a,n,s,u)=>{let l=n;if(s&&M.size(s.dims)>0){if(i===1)throw new Error("AddBiasReshape is not implemented. Please export your model with packed QKV or KV");return l=Gl(e,n,s,t,i,r*a,u),l=l.reshape([t,i,r,a]),r===1||i===1?l:e.compute(Ze(l,wa.perm),{inputs:[l],outputs:[-1]})[0]}else return n.dims.length===3&&(l=n.reshape([t,i,r,a])),r===1||i===1?l:e.compute(Ze(l,wa.perm),{inputs:[l],outputs:[-1]})[0]},Hh=(e,t)=>{let r=Wl(e.inputs,t),i=e.inputs[0],a=Ve(e.inputs,1),n=Ve(e.inputs,2),s=Ve(e.inputs,3),u=Ve(e.inputs,4),l=Ve(e.inputs,5),d=Ve(e.inputs,6),c=Ve(e.inputs,7);if(i.dims.length===5)throw new Error("Packed QKV is not implemented");if((a==null?void 0:a.dims.length)===5)throw new Error("Packed KV is not implemented");let h=a&&n&&a.dims.length===4&&n.dims.length===4,g=vr(e,r.batchSize,r.numHeads,r.sequenceLength,r.headSize,i,s,0);if(h)return Tr(e,g,a,n,u,void 0,d,c,l,r);if(!a||!n)throw new Error("key and value must be provided");let b=vr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.headSize,a,s,r.hiddenSize),y=vr(e,r.batchSize,r.numHeads,r.kvSequenceLength,r.vHeadSize,n,s,2*r.hiddenSize);Tr(e,g,b,y,u,void 0,d,c,l,r)}}),Fl,Hl,jl,Kl,Xa,Kh,Zh,Yh=W(()=>{"use strict";ne(),le(),Be(),de(),Fl=e=>{if(!e||e.length<1)throw new Error("too few inputs")},Hl=(e,t)=>{let r=[],i=t.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(a=>r.push(Number(a))),i=r.length),xe({numOutputs:i,axis:t.axis,splitSizes:r})},jl=e=>`
...
`)}
  ...
  ${C.mainStart()}
    ...
    ${w?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`};return{name:"BlockwiseMatMulNBits32",shaderCache:{hint:`${t.blockSize};${h};${g};${S};${_}`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:b,dataType:c}],dispatchGroup:{x:C},programUniforms:z}),getShaderSource:V}},af=(e,t)=>{ad(e.inputs,t),t.blockSize===32&&e.adapterInfo.isVendor("intel")&&e.adapterInfo.isArchitecture("gen-12lp")?e.compute(sd(e.inputs,t)):e.compute(nd(e.inputs,t))},nf=e=>xe(e)}),od,ud,ld,dd,pd,cd,hd,fd,sf,oy=W(()=>{"use strict";ne(),le(),de(),od=e=>{if(!e||e.length<1)throw new Error("Too few inputs");if(e[0].dataType!==1&&e[0].dataType!==10)throw new Error("Input type must be float or float16.");if(e.length>=2){let t=e[0].dims.length*2===e[1].dims[0];if(e.length===4&&(t=e[3].dims[0]*2===e[1].dims[0]),!t)throw new Error("The pads should be a 1D tensor of shape [2 * input_rank] or [2 * num_axes].")}},ud=(e,t,r)=>{let i="";for(let a=t-1;a>=0;--a)i+=`
    ...
    `,u="",l=U("x",t.dataType,t.dims.length),d=["rank"],[c,h,g,b,y]=xa(n,a);return c.push(...ae(t.dims,n)),{name:e,shaderCache:{hint:`${i.cacheKey};${g};${b};${y}`,inputDependencies:d},getRunData:()=>({outputs:[{dims:n,dataType:t.dataType}],dispatchGroup:{x:Math.ceil(M.size(n)/64)},programUniforms:c}),getShaderSource:_=>Sa(_,l,t.dims.length,n.length,a,s,u,t.dataType===10?-65504:-1e5,h,g,b,y)}},pf=(e,t)=>{mr(e.inputs),e.compute(Ca("MaxPool",e.inputs[0],!1,t))},cf=e=>{let t=e.storage_order,r=e.dilations,i=Ia(e);if(t!==0)throw new Error("column major storage order is not yet supported for MaxPool");if(i.ceilMode!==0)throw new Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel");let a={storageOrder:t,dilations:r,...i,cacheKey:""};return{...a,cacheKey:gd(a)}},hf=e=>{let t=e.format;return{format:t,...Ea,cacheKey:t}},ff=(e,t)=>{mr(e.inputs),e.compute(Ca("GlobalMaxPool",e.inputs[0],!0,t))}}),yd,bd,mf,gf,ly=W(()=>{"use strict";ne(),le(),Be(),de(),yd=(e,t)=>{if(e.length<2||e.length>3)throw new Error("DequantizeLinear requires 2 or 3 inputs.");if(e.length===3&&e[1].dims===e[2].dims)throw new Error("x-scale and x-zero-point must have the same shape.");if(e.length===3&&e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==0&&e[1].dims.length!==1&&e[1].dims.length!==e[0].dims.length)throw new Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw new Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw new Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((r,i)=>r&&i,!0))throw new Error("scale and zero-point inputs must have the same shape.")}if(t.blockSize>0){if(e[1].dims.length===0||e[1].dims.length===1&&e[1].dims[0]===1)throw new Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((a,n)=>n===t.axis||a===e[0].dims[n]).reduce((a,n)=>a&&n,!0))throw new Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw new Error("For block qunatization the scale input rank must be the same as the x rank.");let r=e[0].dims[t.axis],i=e[1].dims[t.axis];if(t.blockSize<Math.ceil(r/i)||t.blockSize>Math.ceil(r/(i-1)-1))throw new Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}},bd=(e,t)=>{let r=M.normalizeAxis(t.axis,e[0].dims.length),i=e[0].dataType,a=i===3,n=e[0].dims,s=e[1].dataType,u=M.size(n),l=i===3||i===2,d=l?[Math.ceil(M.size(e[0].dims)/4)]:e[0].dims,c=e[1].dims,h=e.length>2?e[2]:void 0,g=h?l?[Math.ceil(M.size(h.dims)/4)]:h.dims:void 0,b=c.length===0||c.length===1&&c[0]===1,y=b===!1&&c.length===1,_=Oe(u),S=b&&(!l||_===4),v=S?_:1,w=S&&!l?_:1,I=U("input",l?12:i,d.length,w),k=U("scale",s,c.length),C=h?U("zero_point",l?12:i,g.length):void 0,z=te("output",s,n.length,v),B=[I,k];C&&B.push(C);let $=[d,c];h&&$.push(g);let N=[{type:12,data:u/v},{type:12,data:r},{type:12,data:t.blockSize},...ae(...$,n)],V=K=>{let j=[{name:"output_size",type:"u32"},{name:"axis",type:"u32"},{name:"block_size",type:"u32"}];return`
      ...
      ${z.setByOffset("global_idx",`${z.type.value}(x_value - zero_point_value) * scale_value`)};
      }`};return{name:"DequantizeLinear",shaderCache:{hint:t.cacheKey,inputDependencies:C?["rank","rank","rank"]:["rank","rank"]},getShaderSource:V,getRunData:()=>({outputs:[{dims:n,dataType:s}],dispatchGroup:{x:Math.ceil(u/v/64),y:1,z:1},programUniforms:N})}},mf=(e,t)=>{yd(e.inputs,t),e.compute(bd(e.inputs,t))},gf=e=>xe({axis:e.axis,blockSize:e.blockSize})}),wd,_d,yf,dy=W(()=>{"use strict";Qe(),ne(),de(),wd=(e,t,r)=>{let i=e===t,a=e<t&&r<0,n=e>t&&r>0;if(i||a||n)throw new Error("Range these inputs' contents are invalid.")},_d=(e,t,r,i)=>{let a=Math.abs(Math.ceil((t-e)/r)),n=[a],s=a,u=[{type:12,data:s},{type:i,data:e},{type:i,data:r},...ae(n)],l=d=>{let c=te("output",i,n.length),h=c.type.value,g=[{name:"outputSize",type:"u32"},{name:"start",type:h},{name:"delta",type:h}];return`
        ...
        output[global_idx] = uniforms.start + ${h}(global_idx) * uniforms.delta;
              ...
              ${a}bitcast<${i}>(oldValue) + (${r})${n}`;case"max":return i==="i32"||i==="u32"?`atomicMax(&${t}, bitcast<${i}>(${r}));`:`
                ${a}max(bitcast<f32>(oldValue), (${r}))${n}`;case"min":return i==="i32"||i==="u32"?`atomicMin(&${t}, bitcast<${i}>(${r}));`:`${a}min(bitcast<${i}>(oldValue), (${r}))${n}`;case"mul":return`${a}(bitcast<${i}>(oldValue) * (${r}))${n}`;default:throw new Error(`Reduction ${e} is not supported.`)}},$d=(e,t)=>{let r=e[0].dims,i=e[1].dims,a=r,n=1,s=Math.ceil(M.sizeToDimension(i,i.length-1)/n),u=i[i.length-1],l=M.sizeFromDimension(r,u),d=[{type:12,data:s},{type:12,data:u},{type:12,data:l},...ae(e[1].dims,e[2].dims,a)],c=h=>{let g=U("indices",e[1].dataType,e[1].dims.length),b=U("updates",e[2].dataType,e[2].dims.length,n),y=t.reduction!=="none"&&t.reduction!==""?Wp("output",e[0].dataType,a.length):te("output",e[0].dataType,a.length,n);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${vd(t.reduction,"output[data_offset + i]","value",y.type.value)}
      ...
      }`};return{name:"ScatterND",shaderCache:{hint:`${t.cacheKey}_${t.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:a,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:c}},bf=e=>xe({reduction:e.reduction}),wf=(e,t)=>{e.compute($d(e.inputs,t),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),xd,Sd,Td,za,Id,kd,Ed,Cd,zd,Ad,Od,Bd,Aa,Md,Rd,Nd,Dd,Pd,_f,vf,cy=W(()=>{"use strict";ne(),le(),Be(),de(),xd=(e,t)=>{if(e.every(r=>r>0||(()=>{throw new Error("Resize requires scales input values to be positive")})),e.length>0){if(t.mode==="linear"){if(!(e.length===2||e.length===3||e.length===4&&e[0]===1&&e[1]===1||e.length===4&&e[0]===1&&e[3]===1||e.length===5&&e[0]===1&&e[1]===1))throw new Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
...
`}
      ...
      }`},k=[{dims:u,dataType:e[0].dataType}];return r>1&&k.push({dims:c,dataType:1}),r>2&&k.push({dims:c,dataType:1}),r>3&&k.push({dims:n,dataType:e[0].dataType}),{name:"SkipLayerNormalization",shaderCache:{hint:`${v};${b};${y};${_}`,inputDependencies:e.map((C,z)=>"type")},getShaderSource:I,getRunData:()=>({outputs:k,dispatchGroup:{x:Math.ceil(l/d)},programUniforms:w})}},$f=(e,t)=>{Ud(e.inputs);let r=[0];e.outputCount>1&&r.push(-3),e.outputCount>2&&r.push(-3),e.outputCount>3&&r.push(3),e.compute(Ld(e.inputs,t,e.outputCount,!1),{outputs:r})}}),qd,gr,Vd,Oa,Wd,Gd,xf,Sf,fy=W(()=>{"use strict";ne(),le(),Be(),de(),qd=(e,t)=>{if(!e||e.length<1)throw new Error("too few inputs");if(t.axes.length!==0){if(t.axes.length!==t.starts.length||t.axes.length!==t.ends.length)throw new Error("axes, starts and ends must have the same length")}else if(t.starts.length!==t.ends.length)throw new Error("starts and ends must have the same length");e.slice(1).forEach((r,i)=>{if(e[i+1].dataType!==6&&e[i+1].dataType!==7)throw new Error(`Input ${i} must be an array of int32 or int64`)})},gr=(e,t)=>{let r=[];if(e.length>t)if(e[t].dataType===7)e[t].getBigInt64Array().forEach(i=>r.push(Number(i)));else if(e[t].dataType===6)e[t].getInt32Array().forEach(i=>r.push(Number(i)));else throw new Error(`Input ${t} must be an array of int32 or int64`);return r},Vd=(e,t)=>{if(e.length>1){let r=gr(e,1),i=gr(e,2),a=gr(e,3);return a.length===0&&(a=[...Array(e[0].dims.length).keys()]),xe({starts:r,ends:i,axes:a})}else return t},Oa=(e,t,r,i,a)=>{let n=e;return e<0&&(n+=r[i[t]]),a[t]<0?Math.max(0,Math.min(n,r[i[t]]-1)):Math.max(0,Math.min(n,r[i[t]]))},Wd=(e,t,r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e.type.indices} {
          var input_indices: ${e.type.indices};
          var carry = 0u;
